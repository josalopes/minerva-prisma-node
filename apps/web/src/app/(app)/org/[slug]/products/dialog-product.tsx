  ...
  return (
    <Dialog>
      <DialogHeader>
        ...
        <DialogDescription>Adicionar novo</DialogDescription>
      </DialogHeader>
      ...
      <Form {...form}>
        <form className="space-y-2" onSubmit={handleSubmit}>
          ...
          <div>
                  ...
                  <FormControl>
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem id="kilo" value="kilo" />
                        <Label htmlFor="kilo">Kilo</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem id="litro" value="litro" />
            ...
            <Button
              type="submit"
              className="mt-2 w-full bg-emerald-500 font-semibold text-white"
              disabled={isLoading}
            >
              {isLoading
                ? 'Carregando...'
