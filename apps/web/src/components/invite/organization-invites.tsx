...
export function OrganizationInvites({ organizationId, invites }: Props) {
  ...
  // invite: Invite
    toast.info('Reenvio será implementado em seguida.')
  }

  async function handleDelete() {
  // invite: Invite
    toast.info('Exclusão será implementada em seguida.')
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <InviteForm organizationId={organizationId} onSuccess={handleSuccess} />
    </div>
  )
}
